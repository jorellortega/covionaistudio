-- Migration: 018_add_storyboard_status.sql
-- Description: Add status field to storyboards table for shot status tracking
-- Date: 2024-01-01
...
-- Add comment explaining the new status field
COMMENT ON TABLE public.storyboards IS 'Storyboards for movie scenes with technical and creative details - now includes status tracking for shot workflow management';
